  ...
  return (
    ...
    <section class="
        ...
        <div class='flex items-center justify-center h-30 md:h-10 lg:h-15 md:pt-10 lg:pt-15 md:max-w-full '>
            <h1 class='text-4xl md:text-3xl text-center lg:text-5xl xl:text-6xl 2xl:text-6xl font-extrabold text-secondary '>"A handshake still means something to us here."</h1>
        </div>
