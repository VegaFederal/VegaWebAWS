  ...
  return (
    ...
    <section className='bg-white min-h-fit h-dvh md:min-h-fit 2xl:h-fit sm:overflow-x-visable overflow-x-hidden '>
            <div className='flex flex-col lg:flex-row md:flex-col xl:flex-row  items-center px-4 pt- md:pb-20 md:px-[100px]'>
                ...
                <div className='md:mb-0 xl:mb-15 lg:ml-5 2xl:ml-[5rem] pt-60'>
                    ...
                    <p className='ml-5 text-primary text-lg md:text-[24px] mb-5'>Vega Federal Solutions provides secure, automated technology services for defense, civilian, and national security agencies.</p>
                    ...
                    <p className='ml-5 text-primary text-lg md:text-[24px] mb-5'>At Vega Federal Solutions, we help federal agencies operate faster, smarter, and more securely. Through automation, modern engineering, and real federal experience, we remove friction from complex operations so teams can focus on what matters most: mission success.</p>
                    ...
                    <ul className='ml-5 pl-5' style={{ listStyleType: 'disc' }}>
                        ...
                        <li className='ml-5 text-primary text-lg md:text-[24px] mb-5'>Vega Federal Solutions: automating your mission so the people who carry it out can achieve theirs</li>
                    </ul>
                </div>
            </div>
        </section>
    <section className='bg-white sm:overflow-x-visible overflow-x-hidden px-[5px] md:px-0 pt-10'>
        ...
        <div className='flex flex-col items-start text-left px-4 pt-5 md:pt-10 md:px-[100px] lg:pt-10 xl:pt-20'>
            ...
            <p className='text-primary text-lg md:text-[24px]'>At Vega, we've walked in your shoes. We know the gravity behind every acquisition, every dollar, and every decision. That's why we build solutions that work on day one and keep working when the stakes are highest.</p>
            <h3 className='text-xl md:text-2xl text-primary pt-8 pb-2 font-bold'>Real Experience, Not Theory</h3>
            <p className='text-primary text-lg md:text-[24px]'>Our team is made up of former government civilians, not career consultants. We understand the mission because we've lived it.</p>
    ...
    <section className='bg-white sm:overflow-x-visible overflow-x-hidden px-[5px] md:px-0 pt-10'>
        ...
        <div className='flex flex-col md:flex-row items-center px-4 pt-5 md:pt-10 md:px-[100px] lg:pt-10 xl:pt-20'>
            ...
            <div className='md:mb-0 pb-20 lg:ml-10'>
                ...
                <p className='ml-5 xl:ml-[165px] text-primary text-lg md:text-[24px] md:pt-5 pt-5'>At Vega Federal Solutions, we understand the challenges federal teams face every day. Manual processes, legacy tools, and disconnected systems can slow progress and distract from what matters most, the mission.</p>
