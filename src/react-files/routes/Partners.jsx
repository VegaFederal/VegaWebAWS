...
const Partners = () => {
    ...
    <section className="
            ...
            ">
            <div className='flex flex-col items-left gap-15 ml-15 md:ml-30 2xl:ml-[500px] '>
                <h5 className='text-[48px] text-white font-bold mt-[100px]'>Our Roots.</h5>
                <h3 className='text-[40px] text-secondary  '>Midwestern Values. Global Impact.</h3>
                <ul className='ml-[34px]'>
                    <li className='text-white text-[24px] mb-[24px] ml-[-35px]'>Former government civilians — not career consultants.</li>
                    <li className='text-white text-[24px] mb-[24px] ml-[-35px]'>Deep knowledge of acquisition, readiness, and warfighter needs.</li>
                    <li className='text-white text-[24px] mb-[24px] ml-[-35px]'>We don’t pitch trendy tech.</li>
                    <li className='text-white text-[24px] ml-[-35px]'>We deliver effective, tested solutions.</li>
                </ul>
            </div>
